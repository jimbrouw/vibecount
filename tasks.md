...
- [x] Add real `OPENAI_API_KEY` locally and in Vercel for Whisper transcription.
...
- **Verification note:** implementation is in place and builds cleanly, but this task is
  not complete until the Whisper sub-gate plus logged-in browser testing are run.
